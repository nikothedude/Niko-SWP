...
class MPC_towerScript() : MPC_shieldMissileScript() {
    ...
    override fun createShieldAndFlux(drone: ShipAPI, projectile: CombatEntityAPI?, id: String): ShieldAPI {
        val shield = super.createShieldAndFlux(drone, projectile, id)
    ...
    override fun getShieldRadius(entity: CombatEntityAPI?): Float = if (entity != null) entity.collisionRadius * 5f else 50f
